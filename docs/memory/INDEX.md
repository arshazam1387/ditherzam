...
- [progress|phase 8|done] Smart Mask bake-fill shipped (f19bc2f) — White/Black fill painted pre-dither via bake callable; baked branch renders uncached; preset key bake_fill (054-bake-fill-option.md)
