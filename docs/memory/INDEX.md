...
- [gotcha|phase 7|done] Video export signal-drop fixed — QThreadPool autoDelete killed WorkerSignals before queued finished/error delivery; VideoController now holds workers until terminal signal (051-video-export-signal-drop-fixed.md)
