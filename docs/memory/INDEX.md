...
- [gotcha|phase 8|done] "App gets stuck the more you use it" = render coalescer wedge, NOT a leak: unguarded _RenderWorker.run() exception left _busy stuck True forever; fixed 8240941 with failed signal + _on_render_failed (022-render-worker-wedge-fix.md)
