...
| Native backends | exact blend/transition/selection/Round-brush acceleration and fallbacks | `ditherzam/_native/`, `ditherzam/layers/blend.py`, `ditherzam/composition/transitions.py`, `ditherzam/layers/selection.py`, `ditherzam/layers/mask_brush.py` | `test_native_*_exactness.py`, `test_native_integration_contract.py` |
...
Verified against the working tree on 2026-08-16. Re-verify the selected row before editing.
